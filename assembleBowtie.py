...
for file in seqNames:
    os.system("bowtie2 --no-unal -x results/hh5/hh5 -1 data/"+file+"/"+file+"_1.fastq -2 data/"+file+"/"+file+"_2.fastq -S results/"+file+".sam")
    ...
    numEnd = (file_len("results/"+file+".sam")-3)/2
